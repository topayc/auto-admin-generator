...
@Slf4j
public class MysqlTypeToHtmlTag2 {
     ...
     * @return HTML 태그 문자열
     */
    public static String generateRawHSeachInputTag(String tableName, String columnName, String mysqlType, String columnKey, String comments) {
    ...
    //cols 의 첫번째 md 요소, 두번째 sm 요소 세번째 핸드폰등의 초소형 화면
    public static String generateStyledColWrapedSearchInputTag(String tableName, String columnName, String mysqlType, String columnKey, String comments , String colString) {
     ...
     public static String generateStyledCrateInputTag(String tableName, String columnName, String mysqlType, String columnKey, String comments , String colString) {
        if (mysqlType == null) return "<input type='text' name='" + columnName + "' />";
        ...
        if (baseType.equals("INT") || baseType.equals("INTEGER") ||
            ...
            ContainerTag tag = div().withClass(colString).with(
                div().withClass("form-group").with(
                    label(columnName.toUpperCase()).attr("for", tableName + "_" + columnName).withStyle("font-size : 0.8rem;"),
                input()
                .withName(tableName + "_" + columnName)
